      ...
      <div className="flex items-center justify-between">
        ...
        <nav className="hidden md:block">
          <ul className="flex items-center gap-8 font-medium text-texto">
            {navLinks.map((link) => (
              <li key={link.href}>
                <a href={link.href} className="hover:text-institucional">
                  {link.label}
                </a>
              </li>
            ))}
        ...
        <a
          href="#"
          className="hidden rounded-full bg-institucional px-5 py-2.5 font-medium text-hueso transition-colors hover:bg-institucional/90 md:inline-block"
        >
          Aula virtual
        </a>
            ...
            {navLinks.map((link) => (
              <li key={link.href}>
                <a
                  ...
                  className="block hover:text-institucional"
                >
                  {link.label}
                </a>
              </li>
